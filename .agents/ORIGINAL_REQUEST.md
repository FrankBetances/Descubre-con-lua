...
Proporcionar un conmutador de contexto ágil entre la perspectiva del docente (asamblea matinal, instrucciones breves, temporizador sutil) y la de las familias (explicación del porqué, guía de atención sin saturación, rutina breve de 3-5 min), garantizando que ambas partes puedan coordinar la estimulación sin recargar tareas administrativas.
